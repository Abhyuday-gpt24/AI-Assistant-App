...
from src.app.tools.retrieval_tool import retrieve_tool
...
def graph_build():
    ...
    graph.add_node("kb_retrieval_node", retrieve_tool)
    ...
    graph.add_edge("kb_retrieval_node", "synthesizer_agent_node")
